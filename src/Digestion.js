...
const Digestion = () => {
   ...
   const xp = useXpStore((state) => state.xp)
    ...
    const lines =  wrapText(scienceQuestions.digestion_in_humans[questionNumber].Question)
    
    

    
    const answer = scienceQuestions.digestion_in_humans[questionNumber].Answer;
      const [A_answer, B_answer, C_answer, D_answer] = scienceQuestions.digestion_in_humans[questionNumber].Options;
    ...
    useEffect(()=>{
      ...
      function check_A_Answer() {
        ...
        if (
          scienceQuestions.digestion_in_humans[questionNumber].Answer ===
          scienceQuestions.digestion_in_humans[questionNumber].Options[0]
        ) {
           setWrongAnswerA(false);
          setCorrectAnswerA(true);   
          setBorderColorA(glowCorrect);
       ...
       if(B_answerBox){
        ...
        if (
          scienceQuestions.digestion_in_humans[questionNumber].Answer === scienceQuestions.digestion_in_humans[questionNumber].Options[1]
        ) {
          setCorrectAnswerB(true);
          setWrongAnswerB(false);
         setBorderColorB(glowCorrect);
        ...
        if (
          scienceQuestions.digestion_in_humans[questionNumber].Answer ===
          scienceQuestions.digestion_in_humans[questionNumber].Options[2]
        ) {
        ...
        if (
          scienceQuestions.digestion_in_humans[questionNumber].Answer === scienceQuestions.digestion_in_humans[questionNumber].Options[3]
        ) {
          setCorrectAnswerD(true);
          setWrongAnswerD(false);
          setBorderColorD(glowCorrect);
      ...
      useEffect(()=>{
        if (nextQuestion) {
         ...
         //alert('next question')
          ...
          if (questionNumber === scienceQuestions.digestion_in_humans.length - 1) {
            confetti({
              particleCount: 100,
              spread: 70,
              origin: { y: 0.6 },
     ...
     style = {{
      ...
      >
        ...
        /> 
          ...
          >
             {`[ ${questionNumber} / ${scienceQuestions.digestion_in_humans.length} ]`}  
          </text>  
      </g>
...
/*  Answer Box A  */
  ...
  >
    <path 
        ...
        >
        A. {scienceQuestions.digestion_in_humans[questionNumber].Options[0]}
        </text>
  </g>
  ...
  >
    <path 
        ...
        >
         B. {scienceQuestions.digestion_in_humans[questionNumber].Options[1]}
        </text>
  </g>
 ...
 {/*  Answer Box C */}
  ...
  >
    <path 
        ...
        >
           C. {scienceQuestions.digestion_in_humans[questionNumber].Options[2]}
        </text>
  </g>
 ...
 {/*  Answer Box D */}
  ...
  >
    <path 
        ...
        >
          D. {scienceQuestions.digestion_in_humans[questionNumber].Options[3]} 
        </text>
  </g> 
