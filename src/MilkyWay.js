...
const MilkyWay = () => {
   ...
   const xp = useXpStore((state) => state.xp)
    ...
    const lines =  wrapText(scienceQuestions.milky_way_galaxy[questionNumber].Question)
    
    

    
    const answer = scienceQuestions.milky_way_galaxy[questionNumber].Answer;
      const [A_answer, B_answer, C_answer, D_answer] = scienceQuestions.milky_way_galaxy[questionNumber].Options;
    ...
    useEffect(()=>{
      ...
      function check_A_Answer() {
        ...
        if (
          scienceQuestions.milky_way_galaxy[questionNumber].Answer ===
          scienceQuestions.milky_way_galaxy[questionNumber].Options[0]
        ) {
           setWrongAnswerA(false);
          setCorrectAnswerA(true);   
          setBorderColorA(glowCorrect);
       ...
       if(B_answerBox){
        ...
        if (
          scienceQuestions.milky_way_galaxy[questionNumber].Answer === scienceQuestions.milky_way_galaxy[questionNumber].Options[1]
        ) {
          setCorrectAnswerB(true);
          setWrongAnswerB(false);
         setBorderColorB(glowCorrect);
        ...
        if (
          scienceQuestions.milky_way_galaxy[questionNumber].Answer ===
          scienceQuestions.milky_way_galaxy[questionNumber].Options[2]
        ) {
        ...
        if (
          scienceQuestions.milky_way_galaxy[questionNumber].Answer === scienceQuestions.milky_way_galaxy[questionNumber].Options[3]
        ) {
          setCorrectAnswerD(true);
          setWrongAnswerD(false);
          setBorderColorD(glowCorrect);
      ...
      useEffect(()=>{
        if (nextQuestion) {
         ...
         //alert('next question')
          ...
          if (questionNumber === scienceQuestions.milky_way_galaxy.length - 1) {
            confetti({
              particleCount: 100,
              spread: 70,
              origin: { y: 0.6 },
     ...
     style = {{
      ...
      >
        ...
        /> 
          ...
          >
             {`[ ${questionNumber} / ${scienceQuestions.milky_way_galaxy.length} ]`}  
          </text>  
      </g>
...
/*  Answer Box A  */
  ...
  >
    <path 
        ...
        >
        A. {scienceQuestions.milky_way_galaxy[questionNumber].Options[0]}
        </text>
  </g>
  ...
  >
    <path 
        ...
        >
         B. {scienceQuestions.milky_way_galaxy[questionNumber].Options[1]}
        </text>
  </g>
 ...
 {/*  Answer Box C */}
  ...
  >
    <path 
        ...
        >
           C. {scienceQuestions.milky_way_galaxy[questionNumber].Options[2]}
        </text>
  </g>
 ...
 {/*  Answer Box D */}
  ...
  >
    <path 
        ...
        >
          D. {scienceQuestions.milky_way_galaxy[questionNumber].Options[3]} 
        </text>
  </g> 
