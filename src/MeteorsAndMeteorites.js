...
const MeteorsAndMeteorites = () => {
   ...
   const xp = useXpStore((state) => state.xp)
    ...
    const lines =  wrapText(scienceQuestions.meteors_and_meteorites[questionNumber].Question)
    
    

    
    const answer = scienceQuestions.meteors_and_meteorites[questionNumber].Answer;
      const [A_answer, B_answer, C_answer, D_answer] = scienceQuestions.meteors_and_meteorites[questionNumber].Options;
    ...
    useEffect(()=>{
      ...
      function check_A_Answer() {
        ...
        if (
          scienceQuestions.meteors_and_meteorites[questionNumber].Answer ===
          scienceQuestions.meteors_and_meteorites[questionNumber].Options[0]
        ) {
           setWrongAnswerA(false);
          setCorrectAnswerA(true);   
          setBorderColorA(glowCorrect);
       ...
       if(B_answerBox){
        ...
        if (
          scienceQuestions.meteors_and_meteorites[questionNumber].Answer === scienceQuestions.meteors_and_meteorites[questionNumber].Options[1]
        ) {
          setCorrectAnswerB(true);
          setWrongAnswerB(false);
         setBorderColorB(glowCorrect);
        ...
        if (
          scienceQuestions.meteors_and_meteorites[questionNumber].Answer ===
          scienceQuestions.meteors_and_meteorites[questionNumber].Options[2]
        ) {
        ...
        if (
          scienceQuestions.meteors_and_meteorites[questionNumber].Answer === scienceQuestions.meteors_and_meteorites[questionNumber].Options[3]
        ) {
          setCorrectAnswerD(true);
          setWrongAnswerD(false);
          setBorderColorD(glowCorrect);
      ...
      useEffect(()=>{
        if (nextQuestion) {
         ...
         //alert('next question')
          ...
          if (questionNumber === scienceQuestions.meteors_and_meteorites.length - 1) {
            confetti({
              particleCount: 100,
              spread: 70,
              origin: { y: 0.6 },
     ...
     style = {{
      ...
      >
        ...
        /> 
          ...
          >
             {`[ ${questionNumber} / ${scienceQuestions.meteors_and_meteorites.length} ]`}  
          </text>  
      </g>
...
/*  Answer Box A  */
  ...
  >
    <path 
        ...
        >
        A. {scienceQuestions.meteors_and_meteorites[questionNumber].Options[0]}
        </text>
  </g>
  ...
  >
    <path 
        ...
        >
         B. {scienceQuestions.meteors_and_meteorites[questionNumber].Options[1]}
        </text>
  </g>
 ...
 {/*  Answer Box C */}
  ...
  >
    <path 
        ...
        >
           C. {scienceQuestions.meteors_and_meteorites[questionNumber].Options[2]}
        </text>
  </g>
 ...
 {/*  Answer Box D */}
  ...
  >
    <path 
        ...
        >
          D. {scienceQuestions.meteors_and_meteorites[questionNumber].Options[3]} 
        </text>
  </g> 
