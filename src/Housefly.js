 ...
 const Housefly = () => {
    ...
    const xp = useXpStore((state) => state.xp)
     ...
     const lines =  wrapText(scienceQuestions.life_cycle_of_a_housefly[questionNumber].Question)
     
     
 
     
     const answer = scienceQuestions.life_cycle_of_a_housefly[questionNumber].answer;
       const [A_answer, B_answer, C_answer, D_answer] = scienceQuestions.life_cycle_of_a_housefly[questionNumber].options;
     ...
     useEffect(()=>{
       ...
       function check_A_Answer() {
         ...
         if (
           scienceQuestions.life_cycle_of_a_housefly[questionNumber].answer ===
           scienceQuestions.life_cycle_of_a_housefly[questionNumber].options[0]
         ) {
            setWrongAnswerA(false);
           setCorrectAnswerA(true);   
           setBorderColorA(glowCorrect);
        ...
        if(B_answerBox){
         ...
         if (
           scienceQuestions.life_cycle_of_a_housefly[questionNumber].answer === scienceQuestions.life_cycle_of_a_housefly[questionNumber].options[1]
         ) {
           setCorrectAnswerB(true);
           setWrongAnswerB(false);
          setBorderColorB(glowCorrect);
         ...
         if (
           scienceQuestions.life_cycle_of_a_housefly[questionNumber].Answer ===
           scienceQuestions.life_cycle_of_a_housefly[questionNumber].Options[2]
         ) {
         ...
         if (
           scienceQuestions.life_cycle_of_a_housefly[questionNumber].Answer === scienceQuestions.life_cycle_of_a_housefly[questionNumber].Options[3]
         ) {
           setCorrectAnswerD(true);
           setWrongAnswerD(false);
           setBorderColorD(glowCorrect);
       ...
       useEffect(()=>{
         if (nextQuestion) {
          ...
          //alert('next question')
           ...
           if (questionNumber === scienceQuestions.life_cycle_of_a_housefly.length - 1) {
             confetti({
               particleCount: 100,
               spread: 70,
               origin: { y: 0.6 },
      ...
      style = {{
       ...
       >
         ...
         /> 
           ...
           >
              {`[ ${questionNumber} / ${scienceQuestions.life_cycle_of_a_housefly.length} ]`}  
           </text>  
       </g>
 ...
 /*  Answer Box A  */
   ...
   >
     <path 
         ...
         >
         A. {scienceQuestions.life_cycle_of_a_housefly[questionNumber].Options[0]}
         </text>
   </g>
   ...
   >
     <path 
         ...
         >
          B. {scienceQuestions.life_cycle_of_a_housefly[questionNumber].Options[1]}
         </text>
   </g>
  ...
  {/*  Answer Box C */}
   ...
   >
     <path 
         ...
         >
            C. {scienceQuestions.life_cycle_of_a_housefly[questionNumber].Options[2]}
         </text>
   </g>
  ...
  {/*  Answer Box D */}
   ...
   >
     <path 
         ...
         >
           D. {scienceQuestions.life_cycle_of_a_housefly[questionNumber].Options[3]} 
         </text>
   </g> 
