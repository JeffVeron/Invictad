...
function NewtonsPlayground() {
   ...
   const xp = useXpStore((state) => state.xp)
    ...
    const lines =  wrapText(scienceQuestions.physics_fundamentals[questionNumber].Question)
    
    

    
    const answer = scienceQuestions.physics_fundamentals[questionNumber].Answer;
      const [A_answer, B_answer, C_answer, D_answer] = scienceQuestions.physics_fundamentals[questionNumber].Options;
    ...
    useEffect(()=>{
      ...
      function check_A_Answer() {
        ...
        if (
          scienceQuestions.physics_fundamentals[questionNumber].Answer ===
          scienceQuestions.physics_fundamentals[questionNumber].Options[0]
        ) {
           setWrongAnswerA(false);
          setCorrectAnswerA(true);   
          setBorderColorA(glowCorrect);
       ...
       if(B_answerBox){
        ...
        if (
          scienceQuestions.physics_fundamentals[questionNumber].Answer ===
           scienceQuestions.physics_fundamentals[questionNumber].Options[1]
        ) {
          setCorrectAnswerB(true);
          setWrongAnswerB(false);
         setBorderColorB(glowCorrect);
        ...
        if (
          scienceQuestions.physics_fundamentals[questionNumber].Answer ===
          scienceQuestions.physics_fundamentals[questionNumber].Options[2]
        ) {
        ...
        if (
          scienceQuestions.physics_fundamentals[questionNumber].Answer === 
          scienceQuestions.physics_fundamentals[questionNumber].Options[3]
        ) {
          setCorrectAnswerD(true);
          setWrongAnswerD(false);
          setBorderColorD(glowCorrect);
      ...
      useEffect(()=>{
        if (nextQuestion) {
          ...
          if (questionNumber === scienceQuestions.physics_fundamentals.length - 1) {
            confetti({
              particleCount: 100,
              spread: 70,
              origin: { y: 0.6 },
       ...
       style = {{
        ...
        >
          ...
          /> 
            ...
            >
               {`[ ${questionNumber} / ${scienceQuestions.physics_fundamentals.length} ]`}  
            </text>  
        </g>
  ...
  /*  Answer Box A  */
    ...
    >
      <path 
          ...
          >
          A. {scienceQuestions.physics_fundamentals[questionNumber].Options[0]}
          </text>
    </g>
    ...
    >
      <path 
          ...
          >
           B. {scienceQuestions.physics_fundamentals[questionNumber].Options[1]}
          </text>
    </g>
   ...
   {/*  Answer Box C */}
    ...
    >
      <path 
          ...
          >
             C. {scienceQuestions.physics_fundamentals[questionNumber].Options[2]}
          </text>
    </g>
   ...
   {/*  Answer Box D */}
    ...
    >
      <path 
          ...
          >
            D. {scienceQuestions.physics_fundamentals[questionNumber].Options[3]} 
          </text>
    </g> 
...
export default NewtonsPlayground;  