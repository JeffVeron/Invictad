...
const Ecosystem = () => {
  ...
  const lines =  wrapText(scienceQuestions.ecosystem[questionNumber].question)
    
    

    
    const answer = scienceQuestions.ecosystem[questionNumber].answer;
      const [A_answer, B_answer, C_answer, D_answer] = scienceQuestions.ecosystem[questionNumber].options;
    ...
    useEffect(()=>{
      ...
      function check_A_Answer() {
        ...
        if (
          scienceQuestions.ecosystem[questionNumber].answer ===
          scienceQuestions.ecosystem[questionNumber].options[0]
        ) {
           setWrongAnswerA(false);
          setCorrectAnswerA(true);   
          setBorderColorA(glowCorrect);
       ...
       if(B_answerBox){
        ...
        if (
          scienceQuestions.ecosystem[questionNumber].answer === scienceQuestions.ecosystem[questionNumber].options[1]
        ) {
          setCorrectAnswerB(true);
          setWrongAnswerB(false);
         setBorderColorB(glowCorrect);
        ...
        if (
          scienceQuestions.ecosystem[questionNumber].answer ===
          scienceQuestions.ecosystem[questionNumber].options[2]
        ) {
        ...
        if (
          scienceQuestions.ecosystem[questionNumber].answer === scienceQuestions.ecosystem[questionNumber].options[3]
        ) {
          setCorrectAnswerD(true);
          setWrongAnswerD(false);
          setBorderColorD(glowCorrect);
      ...
      useEffect(()=>{
        if (nextQuestion) {
         ...
         //alert('next question')
          ...
          if (questionNumber === scienceQuestions.ecosystem.length - 1) {
            confetti({
              particleCount: 100,
              spread: 70,
              origin: { y: 0.6 },
     ...
     style = {{
      ...
      >
        ...
        /> 
          ...
          >
             {`[ ${questionNumber} / ${scienceQuestions.ecosystem.length} ]`}  
          </text>  
      </g>
...
/*  Answer Box A  */
  ...
  >
    <path 
        ...
        >
        A. {scienceQuestions.ecosystem[questionNumber].options[0]}
        </text>
  </g>
  ...
  >
    <path 
        ...
        >
         B. {scienceQuestions.ecosystem[questionNumber].options[1]}
        </text>
  </g>
 ...
 {/*  Answer Box C */}
  ...
  >
    <path 
        ...
        >
           C. {scienceQuestions.ecosystem[questionNumber].options[2]}
        </text>
  </g>
 ...
 {/*  Answer Box D */}
  ...
  >
    <path 
        ...
        >
          D. {scienceQuestions.ecosystem[questionNumber].options[3]} 
        </text>
  </g> 
