 ...
 const LivingCells = () => {  
    ...
    const xp = useXpStore((state) => state.xp)
     ...
     const lines =  wrapText(scienceQuestions.plant_and_animal_cells[questionNumber].Question)
     
     
 
     
     const answer = scienceQuestions.plant_and_animal_cells[questionNumber].Answer;
       const [A_answer, B_answer, C_answer, D_answer] = scienceQuestions.plant_and_animal_cells[questionNumber].Options;
     ...
     useEffect(()=>{
       ...
       function check_A_Answer() {
         ...
         if (
           scienceQuestions.plant_and_animal_cells[questionNumber].Answer ===
           scienceQuestions.plant_and_animal_cells[questionNumber].Options[0]
         ) {
            setWrongAnswerA(false);
           setCorrectAnswerA(true);   
           setBorderColorA(glowCorrect);
        ...
        if(B_answerBox){
         ...
         if (
           scienceQuestions.plant_and_animal_cells[questionNumber].Answer === scienceQuestions.plant_and_animal_cells[questionNumber].Options[1]
         ) {
           setCorrectAnswerB(true);
           setWrongAnswerB(false);
          setBorderColorB(glowCorrect);
         ...
         if (
           scienceQuestions.plant_and_animal_cells[questionNumber].Answer ===
           scienceQuestions.plant_and_animal_cells[questionNumber].Options[2]
         ) {
         ...
         if (
           scienceQuestions.plant_and_animal_cells[questionNumber].Answer === scienceQuestions.plant_and_animal_cells[questionNumber].Options[3]
         ) {
           setCorrectAnswerD(true);
           setWrongAnswerD(false);
           setBorderColorD(glowCorrect);
       ...
       useEffect(()=>{
         if (nextQuestion) {
          ...
          //alert('next question')
           ...
           if (questionNumber === scienceQuestions.plant_and_animal_cells.length - 1) {
             confetti({
               particleCount: 100,
               spread: 70,
               origin: { y: 0.6 },
      ...
      style = {{
       ...
       >
         ...
         /> 
           ...
           >
              {`[ ${questionNumber} / ${scienceQuestions.plant_and_animal_cells.length} ]`}  
           </text>  
       </g>
 ...
 /*  Answer Box A  */
   ...
   >
     <path 
         ...
         >
         A. {scienceQuestions.plant_and_animal_cells[questionNumber].Options[0]}
         </text>
   </g>
   ...
   >
     <path 
         ...
         >
          B. {scienceQuestions.plant_and_animal_cells[questionNumber].Options[1]}
         </text>
   </g>
  ...
  {/*  Answer Box C */}
   ...
   >
     <path 
         ...
         >
            C. {scienceQuestions.plant_and_animal_cells[questionNumber].Options[2]}
         </text>
   </g>
  ...
  {/*  Answer Box D */}
   ...
   >
     <path 
         ...
         >
           D. {scienceQuestions.plant_and_animal_cells[questionNumber].Options[3]} 
         </text>
   </g> 
