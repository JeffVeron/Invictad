...
const KuiperBelt = () => {
   ...
   const xp = useXpStore((state) => state.xp)
    ...
    const lines =  wrapText(scienceQuestions.kuipers_belt[questionNumber].Question)
    
    

    
    const answer = scienceQuestions.kuipers_belt[questionNumber].Answer;
      const [A_answer, B_answer, C_answer, D_answer] = scienceQuestions.kuipers_belt[questionNumber].Options;
    ...
    useEffect(()=>{
      ...
      function check_A_Answer() {
        ...
        if (
          scienceQuestions.kuipers_belt[questionNumber].Answer ===
          scienceQuestions.kuipers_belt[questionNumber].Options[0]
        ) {
           setWrongAnswerA(false);
          setCorrectAnswerA(true);   
          setBorderColorA(glowCorrect);
       ...
       if(B_answerBox){
        ...
        if (
          scienceQuestions.kuipers_belt[questionNumber].Answer === scienceQuestions.kuipers_belt[questionNumber].Options[1]
        ) {
          setCorrectAnswerB(true);
          setWrongAnswerB(false);
         setBorderColorB(glowCorrect);
        ...
        if (
          scienceQuestions.kuipers_belt[questionNumber].Answer ===
          scienceQuestions.kuipers_belt[questionNumber].Options[2]
        ) {
        ...
        if (
          scienceQuestions.kuipers_belt[questionNumber].Answer === scienceQuestions.kuipers_belt[questionNumber].Options[3]
        ) {
          setCorrectAnswerD(true);
          setWrongAnswerD(false);
          setBorderColorD(glowCorrect);
      ...
      useEffect(()=>{
        if (nextQuestion) {
         ...
         //alert('next question')
          ...
          if (questionNumber === scienceQuestions.kuipers_belt.length - 1) {
            confetti({
              particleCount: 100,
              spread: 70,
              origin: { y: 0.6 },
     ...
     style = {{
      ...
      >
        ...
        /> 
          ...
          >
             {`[ ${questionNumber} / ${scienceQuestions.kuipers_belt.length} ]`}  
          </text>  
      </g>
...
/*  Answer Box A  */
  ...
  >
    <path 
        ...
        >
        A. {scienceQuestions.kuipers_belt[questionNumber].Options[0]}
        </text>
  </g>
  ...
  >
    <path 
        ...
        >
         B. {scienceQuestions.kuipers_belt[questionNumber].Options[1]}
        </text>
  </g>
 ...
 {/*  Answer Box C */}
  ...
  >
    <path 
        ...
        >
           C. {scienceQuestions.kuipers_belt[questionNumber].Options[2]}
        </text>
  </g>
 ...
 {/*  Answer Box D */}
  ...
  >
    <path 
        ...
        >
          D. {scienceQuestions.kuipers_belt[questionNumber].Options[3]} 
        </text>
  </g> 
