 ...
 const CarbonCycle = () => {
    ...
    const xp = useXpStore((state) => state.xp)
     ...
     const lines =  wrapText(scienceQuestions.carbon_cycles[questionNumber].Question)
     
     
 
     
     const answer = scienceQuestions.carbon_cycles[questionNumber].answer;
       const [A_answer, B_answer, C_answer, D_answer] = scienceQuestions.carbon_cycles[questionNumber].options;
     ...
     useEffect(()=>{
       ...
       function check_A_Answer() {
         ...
         if (
           scienceQuestions.carbon_cycles[questionNumber].answer ===
           scienceQuestions.carbon_cycles[questionNumber].options[0]
         ) {
            setWrongAnswerA(false);
           setCorrectAnswerA(true);   
           setBorderColorA(glowCorrect);
        ...
        if(B_answerBox){
         ...
         if (
           scienceQuestions.carbon_cycles[questionNumber].answer === scienceQuestions.carbon_cycles[questionNumber].options[1]
         ) {
           setCorrectAnswerB(true);
           setWrongAnswerB(false);
          setBorderColorB(glowCorrect);
         ...
         if (
           scienceQuestions.carbon_cycles[questionNumber].answer ===
           scienceQuestions.carbon_cycles[questionNumber].options[2]
         ) {
         ...
         if (
           scienceQuestions.carbon_cycles[questionNumber].answer === scienceQuestions.carbon_cycles[questionNumber].options[3]
         ) {
           setCorrectAnswerD(true);
           setWrongAnswerD(false);
           setBorderColorD(glowCorrect);
       ...
       useEffect(()=>{
         if (nextQuestion) {
          ...
          //alert('next question')
           ...
           if (questionNumber === scienceQuestions.carbon_cycles.length - 1) {
             confetti({
               particleCount: 100,
               spread: 70,
               origin: { y: 0.6 },
      ...
      style = {{
       ...
       >
         ...
         /> 
           ...
           >
              {`[ ${questionNumber} / ${scienceQuestions.carbon_cycles.length} ]`}  
           </text>  
       </g>
 ...
 /*  Answer Box A  */
   ...
   >
     <path 
         ...
         >
         A. {scienceQuestions.carbon_cycles[questionNumber].options[0]}
         </text>
   </g>
   ...
   >
     <path 
         ...
         >
          B. {scienceQuestions.carbon_cycles[questionNumber].options[1]}
         </text>
   </g>
  ...
  {/*  Answer Box C */}
   ...
   >
     <path 
         ...
         >
            C. {scienceQuestions.carbon_cycles[questionNumber].options[2]}
         </text>
   </g>
  ...
  {/*  Answer Box D */}
   ...
   >
     <path 
         ...
         >
           D. {scienceQuestions.carbon_cycles[questionNumber].options[3]} 
         </text>
   </g> 
