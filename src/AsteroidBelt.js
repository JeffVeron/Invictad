...
const AsteroidBelt = () => {
   ...
   const xp = useXpStore((state) => state.xp)
    ...
    const lines =  wrapText(scienceQuestions.asteroid_belt[questionNumber].Question)
    
    

    
    const answer = scienceQuestions.asteroid_belt[questionNumber].Answer;
      const [A_answer, B_answer, C_answer, D_answer] = scienceQuestions.asteroid_belt[questionNumber].Options;
    ...
    useEffect(()=>{
      ...
      function check_A_Answer() {
        ...
        if (
          scienceQuestions.asteroid_belt[questionNumber].Answer ===
          scienceQuestions.asteroid_belt[questionNumber].Options[0]
        ) {
           setWrongAnswerA(false);
          setCorrectAnswerA(true);   
          setBorderColorA(glowCorrect);
       ...
       if(B_answerBox){
        ...
        if (
          scienceQuestions.asteroid_belt[questionNumber].Answer === scienceQuestions.asteroid_belt[questionNumber].Options[1]
        ) {
          setCorrectAnswerB(true);
          setWrongAnswerB(false);
         setBorderColorB(glowCorrect);
        ...
        if (
          scienceQuestions.asteroid_belt[questionNumber].Answer ===
          scienceQuestions.asteroid_belt[questionNumber].Options[2]
        ) {
        ...
        if (
          scienceQuestions.asteroid_belt[questionNumber].Answer === scienceQuestions.asteroid_belt[questionNumber].Options[3]
        ) {
          setCorrectAnswerD(true);
          setWrongAnswerD(false);
          setBorderColorD(glowCorrect);
      ...
      useEffect(()=>{
        if (nextQuestion) {
         ...
         //alert('next question')
          ...
          if (questionNumber === scienceQuestions.asteroid_belt.length - 1) {
            confetti({
              particleCount: 100,
              spread: 70,
              origin: { y: 0.6 },
     ...
     style = {{
      ...
      >
        ...
        /> 
          ...
          >
             {`[ ${questionNumber} / ${scienceQuestions.asteroid_belt.length} ]`}  
          </text>  
      </g>
...
/*  Answer Box A  */
  ...
  >
    <path 
        ...
        >
        A. {scienceQuestions.asteroid_belt[questionNumber].Options[0]}
        </text>
  </g>
  ...
  >
    <path 
        ...
        >
         B. {scienceQuestions.asteroid_belt[questionNumber].Options[1]}
        </text>
  </g>
 ...
 {/*  Answer Box C */}
  ...
  >
    <path 
        ...
        >
           C. {scienceQuestions.asteroid_belt[questionNumber].Options[2]}
        </text>
  </g>
 ...
 {/*  Answer Box D */}
  ...
  >
    <path 
        ...
        >
          D. {scienceQuestions.asteroid_belt[questionNumber].Options[3]} 
        </text>
  </g> 
