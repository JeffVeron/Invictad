...
function EcosystemExplorers() {
   ...
   const xp = useXpStore((state) => state.xp)
    ...
    const lines =  wrapText(scienceQuestions.ecosystem_explorers[questionNumber].Question)
    
    

    
    const answer = scienceQuestions.ecosystem_explorers[questionNumber].Answer;
      const [A_answer, B_answer, C_answer, D_answer] = scienceQuestions.ecosystem_explorers[questionNumber].Options;
    ...
    useEffect(()=>{
      ...
      function check_A_Answer() {
        ...
        if (
          scienceQuestions.ecosystem_explorers[questionNumber].Answer ===
          scienceQuestions.ecosystem_explorers[questionNumber].Options[0]
        ) {
           setWrongAnswerA(false);
          setCorrectAnswerA(true);   
          setBorderColorA(glowCorrect);
       ...
       if(B_answerBox){
        ...
        if (
          scienceQuestions.ecosystem_explorers[questionNumber].Answer ===
           scienceQuestions.ecosystem_explorers[questionNumber].Options[1]
        ) {
          setCorrectAnswerB(true);
          setWrongAnswerB(false);
         setBorderColorB(glowCorrect);
        ...
        if (
          scienceQuestions.ecosystem_explorers[questionNumber].Answer ===
          scienceQuestions.ecosystem_explorers[questionNumber].Options[2]
        ) {
        ...
        if (
          scienceQuestions.ecosystem_explorers[questionNumber].Answer === 
          scienceQuestions.ecosystem_explorers[questionNumber].Options[3]
        ) {
          setCorrectAnswerD(true);
          setWrongAnswerD(false);
          setBorderColorD(glowCorrect);
      ...
      useEffect(()=>{
        if (nextQuestion) {
          ...
          if (questionNumber === scienceQuestions.ecosystem_explorers.length - 1) {
            confetti({
              particleCount: 100,
              spread: 70,
              origin: { y: 0.6 },
       ...
       style = {{
        ...
        >
          ...
          /> 
            ...
            >
               {`[ ${questionNumber} / ${scienceQuestions.ecosystem_explorers.length} ]`}  
            </text>  
        </g>
  ...
  /*  Answer Box A  */
    ...
    >
      <path 
          ...
          >
          A. {scienceQuestions.ecosystem_explorers[questionNumber].Options[0]}
          </text>
    </g>
    ...
    >
      <path 
          ...
          >
           B. {scienceQuestions.ecosystem_explorers[questionNumber].Options[1]}
          </text>
    </g>
   ...
   {/*  Answer Box C */}
    ...
    >
      <path 
          ...
          >
             C. {scienceQuestions.ecosystem_explorers[questionNumber].Options[2]}
          </text>
    </g>
   ...
   {/*  Answer Box D */}
    ...
    >
      <path 
          ...
          >
            D. {scienceQuestions.ecosystem_explorers[questionNumber].Options[3]} 
          </text>
    </g> 
...
export default EcosystemExplorers;
