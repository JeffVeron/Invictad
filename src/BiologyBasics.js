...
function BiologyBasics() {
   ...
   const xp = useXpStore((state) => state.xp)
    ...
    const lines =  wrapText(scienceQuestions.biology_basics[questionNumber].Question)
    
    

    
    const answer = scienceQuestions.biology_basics[questionNumber].Answer;
      const [A_answer, B_answer, C_answer, D_answer] = scienceQuestions.biology_basics[questionNumber].Options;
    ...
    useEffect(()=>{
      ...
      function check_A_Answer() {
        ...
        if (
          scienceQuestions.biology_basics[questionNumber].Answer ===
          scienceQuestions.biology_basics[questionNumber].Options[0]
        ) {
           setWrongAnswerA(false);
          setCorrectAnswerA(true);   
          setBorderColorA(glowCorrect);
       ...
       if(B_answerBox){
        ...
        if (
          scienceQuestions.biology_basics[questionNumber].Answer ===
           scienceQuestions.biology_basics[questionNumber].Options[1]
        ) {
          setCorrectAnswerB(true);
          setWrongAnswerB(false);
         setBorderColorB(glowCorrect);
        ...
        if (
          scienceQuestions.biology_basics[questionNumber].Answer ===
          scienceQuestions.biology_basics[questionNumber].Options[2]
        ) {
        ...
        if (
          scienceQuestions.biology_basics[questionNumber].Answer === 
          scienceQuestions.biology_basics[questionNumber].Options[3]
        ) {
          setCorrectAnswerD(true);
          setWrongAnswerD(false);
          setBorderColorD(glowCorrect);
      ...
      useEffect(()=>{
        if (nextQuestion) {
          ...
          if (questionNumber === scienceQuestions.biology_basics.length - 1) {
            confetti({
              particleCount: 100,
              spread: 70,
              origin: { y: 0.6 },
       ...
       style = {{
        ...
        >
          ...
          /> 
            ...
            >
               {`[ ${questionNumber} / ${scienceQuestions.biology_basics.length} ]`}  
            </text>  
        </g>
  ...
  /*  Answer Box A  */
    ...
    >
      <path 
          ...
          >
          A. {scienceQuestions.biology_basics[questionNumber].Options[0]}
          </text>
    ...
    >
      <path 
          ...
          >
           B. {scienceQuestions.biology_basics[questionNumber].Options[1]}
          </text>
    </g>
   ...
   {/*  Answer Box C */}
    ...
    >
      <path 
          ...
          >
             C. {scienceQuestions.biology_basics[questionNumber].Options[2]}
          </text>
    </g>
   ...
   {/*  Answer Box D */}
    ...
    >
      <path 
          ...
          >
            D. {scienceQuestions.biology_basics[questionNumber].Options[3]} 
          </text>
    </g> 
