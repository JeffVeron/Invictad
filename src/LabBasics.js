...
const LabBasics = () => {
   ...
   const xp = useXpStore((state) => state.xp)
    ...
    const lines =  wrapText(scienceQuestions.lab_basics[questionNumber].Question)
    
    

    
    const answer = scienceQuestions.lab_basics[questionNumber].Answer;
      const [A_answer, B_answer, C_answer, D_answer] = scienceQuestions.lab_basics[questionNumber].Options;
    ...
    useEffect(()=>{
      ...
      function check_A_Answer() {
        ...
        if (
          scienceQuestions.lab_basics[questionNumber].Answer ===
          scienceQuestions.lab_basics[questionNumber].Options[0]
        ) {
           setWrongAnswerA(false);
          setCorrectAnswerA(true);   
          setBorderColorA(glowCorrect);
       ...
       if(B_answerBox){
        ...
        if (
          scienceQuestions.lab_basics[questionNumber].Answer === scienceQuestions.lab_basics[questionNumber].Options[1]
        ) {
          setCorrectAnswerB(true);
          setWrongAnswerB(false);
         setBorderColorB(glowCorrect);
        ...
        if (
          scienceQuestions.lab_basics[questionNumber].Answer ===
          scienceQuestions.lab_basics[questionNumber].Options[2]
        ) {
        ...
        if (
          scienceQuestions.lab_basics[questionNumber].Answer === scienceQuestions.lab_basics[questionNumber].Options[3]
        ) {
          setCorrectAnswerD(true);
          setWrongAnswerD(false);
          setBorderColorD(glowCorrect);
      ...
      useEffect(()=>{
        if (nextQuestion) {
         ...
         //alert('next question')
          ...
          if (questionNumber === scienceQuestions.lab_basics.length - 1) {
            confetti({
              particleCount: 100,
              spread: 70,
              origin: { y: 0.6 },
      ...
      },[continnue , nextQuestion ,questionNumber ])
     ...
     style = {{
      ...
      >
        ...
        /> 
          ...
          >
             {`[ ${questionNumber} / ${scienceQuestions.lab_basics.length} ]`}  
          </text>  
      </g>
...
/*  Answer Box A  */
  ...
  >
    <path 
        ...
        >
        A. {scienceQuestions.lab_basics[questionNumber].Options[0]}
        </text>
  </g>
  ...
  >
    <path 
        ...
        >
         B. {scienceQuestions.lab_basics[questionNumber].Options[1]}
        </text>
  </g>
 ...
 {/*  Answer Box C */}
  ...
  >
    <path 
        ...
        >
           C. {scienceQuestions.lab_basics[questionNumber].Options[2]}
        </text>
  </g>
 ...
 {/*  Answer Box D */}
  ...
  >
    <path 
        ...
        >
          D. {scienceQuestions.lab_basics[questionNumber].Options[3]} 
        </text>
  </g> 
