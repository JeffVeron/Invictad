...
function AtomicAlley() {
        ...
        const xp = useXpStore((state) => state.xp)
         ...
         const lines =  wrapText(scienceQuestions.atomic_alley[questionNumber].Question)
         
         
     
         
         const answer = scienceQuestions.atomic_alley[questionNumber].Answer;
           const [A_answer, B_answer, C_answer, D_answer] = scienceQuestions.atomic_alley[questionNumber].Options;
         ...
         useEffect(()=>{
           ...
           function check_A_Answer() {
             ...
             if (
               scienceQuestions.atomic_alley[questionNumber].Answer ===
               scienceQuestions.atomic_alley[questionNumber].Options[0]
             ) {
                setWrongAnswerA(false);
               setCorrectAnswerA(true);   
               setBorderColorA(glowCorrect);
            ...
            if(B_answerBox){
             ...
             if (
               scienceQuestions.atomic_alley[questionNumber].Answer === scienceQuestions.atomic_alley[questionNumber].Options[1]
             ) {
               setCorrectAnswerB(true);
               setWrongAnswerB(false);
              setBorderColorB(glowCorrect);
             ...
             if (
               scienceQuestions.atomic_alley[questionNumber].Answer ===
               scienceQuestions.atomic_alley[questionNumber].Options[2]
             ) {
             ...
             if (
               scienceQuestions.atomic_alley[questionNumber].Answer === scienceQuestions.atomic_alley[questionNumber].Options[3]
             ) {
               setCorrectAnswerD(true);
               setWrongAnswerD(false);
               setBorderColorD(glowCorrect);
           ...
           useEffect(()=>{
             if (nextQuestion) {
              ...
              //alert('next question')
               ...
               if (questionNumber === scienceQuestions.atomic_alley.length - 1) {
                 confetti({
                   particleCount: 100,
                   spread: 70,
                   origin: { y: 0.6 },
          ...
          style = {{
           ...
           >
             ...
             /> 
               ...
               >
                  {`[ ${questionNumber} / ${scienceQuestions.atomic_alley.length} ]`}  
               </text>  
           </g>
     ...
     /*  Answer Box A  */
       ...
       >
         <path 
             ...
             >
             A. {scienceQuestions.atomic_alley[questionNumber].Options[0]}
             </text>
       </g>
       ...
       >
         <path 
             ...
             >
              B. {scienceQuestions.atomic_alley[questionNumber].Options[1]}
             </text>
       </g>
      ...
      {/*  Answer Box C */}
       ...
       >
         <path 
             ...
             >
                C. {scienceQuestions.atomic_alley[questionNumber].Options[2]}
             </text>
       </g>
      ...
      {/*  Answer Box D */}
       ...
       >
         <path 
             ...
             >
               D. {scienceQuestions.atomic_alley[questionNumber].Options[3]} 
             </text>
       </g> 
