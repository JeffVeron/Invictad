 ...
 const AnimalFeed = () => {
    ...
    const xp = useXpStore((state) => state.xp)
     ...
     const lines =  wrapText(scienceQuestions.animal_feed[questionNumber].question)
     
     
 
     
     const answer = scienceQuestions.animal_feed[questionNumber].answer;
       const [A_answer, B_answer, C_answer, D_answer] = scienceQuestions.animal_feed[questionNumber].options;
     ...
     useEffect(()=>{
       ...
       function check_A_Answer() {
         ...
         if (
           scienceQuestions.animal_feed[questionNumber].answer ===
           scienceQuestions.animal_feed[questionNumber].options[0]
         ) {
            setWrongAnswerA(false);
           setCorrectAnswerA(true);   
           setBorderColorA(glowCorrect);
        ...
        if(B_answerBox){
         ...
         if (
           scienceQuestions.animal_feed[questionNumber].answer === scienceQuestions.animal_feed[questionNumber].options[1]
         ) {
           setCorrectAnswerB(true);
           setWrongAnswerB(false);
          setBorderColorB(glowCorrect);
         ...
         if (
           scienceQuestions.animal_feed[questionNumber].answer ===
           scienceQuestions.animal_feed[questionNumber].options[2]
         ) {
         ...
         if (
           scienceQuestions.animal_feed[questionNumber].answer === scienceQuestions.animal_feed[questionNumber].options[3]
         ) {
           setCorrectAnswerD(true);
           setWrongAnswerD(false);
           setBorderColorD(glowCorrect);
       ...
       useEffect(()=>{
         if (nextQuestion) {
          ...
          //alert('next question')
           ...
           if (questionNumber === scienceQuestions.animal_feed.length - 1) {
             confetti({
               particleCount: 100,
               spread: 70,
               origin: { y: 0.6 },
      ...
      style = {{
       ...
       >
         ...
         /> 
           ...
           >
              {`[ ${questionNumber} / ${scienceQuestions.animal_feed.length} ]`}  
           </text>  
       </g>
 ...
 /*  Answer Box A  */
   ...
   >
     <path 
         ...
         >
         A. {scienceQuestions.animal_feed[questionNumber].options[0]}
         </text>
   </g>
   ...
   >
     <path 
         ...
         >
          B. {scienceQuestions.animal_feed[questionNumber].options[1]}
         </text>
   </g>
  ...
  {/*  Answer Box C */}
   ...
   >
     <path 
         ...
         >
            C. {scienceQuestions.animal_feed[questionNumber].options[2]}
         </text>
   </g>
  ...
  {/*  Answer Box D */}
   ...
   >
     <path 
         ...
         >
           D. {scienceQuestions.animal_feed[questionNumber].options[3]} 
         </text>
   </g> 
