...
function CosmicCuriosities() {
   ...
   const xp = useXpStore((state) => state.xp)
    ...
    const lines =  wrapText(scienceQuestions.cosmic_curiosities[questionNumber].Question)
    
    

    
    const answer = scienceQuestions.cosmic_curiosities[questionNumber].Answer;
      const [A_answer, B_answer, C_answer, D_answer] = scienceQuestions.cosmic_curiosities[questionNumber].Options;
    ...
    useEffect(()=>{
      ...
      function check_A_Answer() {
        ...
        if (
          scienceQuestions.cosmic_curiosities[questionNumber].Answer ===
          scienceQuestions.cosmic_curiosities[questionNumber].Options[0]
        ) {
           setWrongAnswerA(false);
          setCorrectAnswerA(true);   
          setBorderColorA(glowCorrect);
       ...
       if(B_answerBox){
        ...
        if (
          scienceQuestions.cosmic_curiosities[questionNumber].Answer ===
           scienceQuestions.cosmic_curiosities[questionNumber].Options[1]
        ) {
          setCorrectAnswerB(true);
          setWrongAnswerB(false);
         setBorderColorB(glowCorrect);
        ...
        if (
          scienceQuestions.cosmic_curiosities[questionNumber].Answer ===
          scienceQuestions.cosmic_curiosities[questionNumber].Options[2]
        ) {
        ...
        if (
          scienceQuestions.cosmic_curiosities[questionNumber].Answer === 
          scienceQuestions.cosmic_curiosities[questionNumber].Options[3]
        ) {
          setCorrectAnswerD(true);
          setWrongAnswerD(false);
          setBorderColorD(glowCorrect);
      ...
      useEffect(()=>{
        if (nextQuestion) {
          ...
          if (questionNumber === scienceQuestions.cosmic_curiosities.length - 1) {
            confetti({
              particleCount: 100,
              spread: 70,
              origin: { y: 0.6 },
       ...
       style = {{
        ...
        >
          ...
          /> 
            ...
            >
               {`[ ${questionNumber} / ${scienceQuestions.cosmic_curiosities.length} ]`}  
            </text>  
        </g>
  ...
  /*  Answer Box A  */
    ...
    >
      <path 
          ...
          >
          A. {scienceQuestions.cosmic_curiosities[questionNumber].Options[0]}
          </text>
    </g>
    ...
    >
      <path 
          ...
          >
           B. {scienceQuestions.cosmic_curiosities[questionNumber].Options[1]}
          </text>
    </g>
   ...
   {/*  Answer Box C */}
    ...
    >
      <path 
          ...
          >
             C. {scienceQuestions.cosmic_curiosities[questionNumber].Options[2]}
          </text>
    </g>
   ...
   {/*  Answer Box D */}
    ...
    >
      <path 
          ...
          >
            D. {scienceQuestions.cosmic_curiosities[questionNumber].Options[3]} 
          </text>
    </g> 
...
export default CosmicCuriosities;
