 ...
 const ProkaryoticCells = () => {
    ...
    const xp = useXpStore((state) => state.xp)
     ...
     const lines =  wrapText(scienceQuestions.eaukaryotic_and_prokaryotics[questionNumber].Question)
     
     
 
     
     const answer = scienceQuestions.eaukaryotic_and_prokaryotics[questionNumber].answer;
       const [A_answer, B_answer, C_answer, D_answer] = scienceQuestions.eaukaryotic_and_prokaryotics[questionNumber].options;
     ...
     useEffect(()=>{
       ...
       function check_A_Answer() {
         ...
         if (
           scienceQuestions.eaukaryotic_and_prokaryotics[questionNumber].answer ===
           scienceQuestions.eaukaryotic_and_prokaryotics[questionNumber].options[0]
         ) {
            setWrongAnswerA(false);
           setCorrectAnswerA(true);   
           setBorderColorA(glowCorrect);
        ...
        if(B_answerBox){
         ...
         if (
           scienceQuestions.eaukaryotic_and_prokaryotics[questionNumber].answer === scienceQuestions.eaukaryotic_and_prokaryotics[questionNumber].options[1]
         ) {
           setCorrectAnswerB(true);
           setWrongAnswerB(false);
          setBorderColorB(glowCorrect);
         ...
         if (
           scienceQuestions.eaukaryotic_and_prokaryotics[questionNumber].answer ===
           scienceQuestions.eaukaryotic_and_prokaryotics[questionNumber].options[2]
         ) {
         ...
         if (
           scienceQuestions.eaukaryotic_and_prokaryotics[questionNumber].answer === scienceQuestions.eaukaryotic_and_prokaryotics[questionNumber].options[3]
         ) {
           setCorrectAnswerD(true);
           setWrongAnswerD(false);
           setBorderColorD(glowCorrect);
       ...
       useEffect(()=>{
         if (nextQuestion) {
          ...
          //alert('next question')
           ...
           if (questionNumber === scienceQuestions.eaukaryotic_and_prokaryotics.length - 1) {
             confetti({
               particleCount: 100,
               spread: 70,
               origin: { y: 0.6 },
   ...
   return (
     ...
     > Eukaryotic And Prokaryotic Cells </h1>   
      ...
      style = {{
       ...
       >
         ...
         /> 
           ...
           >
              {`[ ${questionNumber} / ${scienceQuestions.eaukaryotic_and_prokaryotics.length} ]`}  
           </text>  
       </g>
 ...
 /*  Answer Box A  */
   ...
   >
     <path 
         ...
         >
         A. {scienceQuestions.eaukaryotic_and_prokaryotics[questionNumber].options[0]}
         </text>
   </g>
   ...
   >
     <path 
         ...
         >
          B. {scienceQuestions.eaukaryotic_and_prokaryotics[questionNumber].options[1]}
         </text>
   </g>
  ...
  {/*  Answer Box C */}
   ...
   >
     <path 
         ...
         >
            C. {scienceQuestions.eaukaryotic_and_prokaryotics[questionNumber].options[2]}
         </text>
   </g>
  ...
  {/*  Answer Box D */}
   ...
   >
     <path 
         ...
         >
           D. {scienceQuestions.eaukaryotic_and_prokaryotics[questionNumber].options[3]} 
         </text>
   </g> 
