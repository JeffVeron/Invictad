 ...
 const FarmingSystems = () => {
    ...
    const xp = useXpStore((state) => state.xp)
     ...
     const lines =  wrapText(scienceQuestions.farming_systems[questionNumber].Question)
     
     
 
     
     const answer = scienceQuestions.farming_systems[questionNumber].answer;
       const [A_answer, B_answer, C_answer, D_answer] = scienceQuestions.farming_systems[questionNumber].options;
     ...
     useEffect(()=>{
       ...
       function check_A_Answer() {
         ...
         if (
           scienceQuestions.farming_systems[questionNumber].answer ===
           scienceQuestions.farming_systems[questionNumber].options[0]
         ) {
            setWrongAnswerA(false);
           setCorrectAnswerA(true);   
           setBorderColorA(glowCorrect);
        ...
        if(B_answerBox){
         ...
         if (
           scienceQuestions.farming_systems[questionNumber].answer === scienceQuestions.farming_systems[questionNumber].options[1]
         ) {
           setCorrectAnswerB(true);
           setWrongAnswerB(false);
          setBorderColorB(glowCorrect);
         ...
         if (
           scienceQuestions.farming_systems[questionNumber].answer ===
           scienceQuestions.farming_systems[questionNumber].options[2]
         ) {
         ...
         if (
           scienceQuestions.farming_systems[questionNumber].answer === scienceQuestions.farming_systems[questionNumber].options[3]
         ) {
           setCorrectAnswerD(true);
           setWrongAnswerD(false);
           setBorderColorD(glowCorrect);
       ...
       useEffect(()=>{
         if (nextQuestion) {
          ...
          //alert('next question')
           ...
           if (questionNumber === scienceQuestions.farming_systems.length - 1) {
             confetti({
               particleCount: 100,
               spread: 70,
               origin: { y: 0.6 },
      ...
      style = {{
       ...
       >
         ...
         /> 
           ...
           >
              {`[ ${questionNumber} / ${scienceQuestions.farming_systems.length} ]`}  
           </text>  
       </g>
 ...
 /*  Answer Box A  */
   ...
   >
     <path 
         ...
         >
         A. {scienceQuestions.farming_systems[questionNumber].options[0]}
         </text>
   </g>
   ...
   >
     <path 
         ...
         >
          B. {scienceQuestions.farming_systems[questionNumber].options[1]}
         </text>
   </g>
  ...
  {/*  Answer Box C */}
   ...
   >
     <path 
         ...
         >
            C. {scienceQuestions.farming_systems[questionNumber].options[2]}
         </text>
   </g>
  ...
  {/*  Answer Box D */}
   ...
   >
     <path 
         ...
         >
           D. {scienceQuestions.farming_systems[questionNumber].options[3]} 
         </text>
   </g> 
