...
const TheGalaxies = () => {
   ...
   const xp = useXpStore((state) => state.xp)
    ...
    const lines =  wrapText(scienceQuestions.the_galaxies[questionNumber].Question)
    
    

    
    const answer = scienceQuestions.the_galaxies[questionNumber].Answer;
      const [A_answer, B_answer, C_answer, D_answer] = scienceQuestions.the_galaxies[questionNumber].Options;
    ...
    useEffect(()=>{
      ...
      function check_A_Answer() {
        ...
        if (
          scienceQuestions.the_galaxies[questionNumber].Answer ===
          scienceQuestions.the_galaxies[questionNumber].Options[0]
        ) {
           setWrongAnswerA(false);
          setCorrectAnswerA(true);   
          setBorderColorA(glowCorrect);
       ...
       if(B_answerBox){
        ...
        if (
          scienceQuestions.the_galaxies[questionNumber].Answer === scienceQuestions.the_galaxies[questionNumber].Options[1]
        ) {
          setCorrectAnswerB(true);
          setWrongAnswerB(false);
         setBorderColorB(glowCorrect);
        ...
        if (
          scienceQuestions.the_galaxies[questionNumber].Answer ===
          scienceQuestions.the_galaxies[questionNumber].Options[2]
        ) {
        ...
        if (
          scienceQuestions.the_galaxies[questionNumber].Answer === scienceQuestions.the_galaxies[questionNumber].Options[3]
        ) {
          setCorrectAnswerD(true);
          setWrongAnswerD(false);
          setBorderColorD(glowCorrect);
      ...
      useEffect(()=>{
        if (nextQuestion) {
         ...
         //alert('next question')
          ...
          if (questionNumber === scienceQuestions.the_galaxies.length - 1) {
            confetti({
              particleCount: 100,
              spread: 70,
              origin: { y: 0.6 },
     ...
     style = {{
      ...
      >
        ...
        /> 
          ...
          >
             {`[ ${questionNumber} / ${scienceQuestions.the_galaxies.length} ]`}  
          </text>  
      </g>
...
/*  Answer Box A  */
  ...
  >
    <path 
        ...
        >
        A. {scienceQuestions.the_galaxies[questionNumber].Options[0]}
        </text>
  </g>
  ...
  >
    <path 
        ...
        >
         B. {scienceQuestions.the_galaxies[questionNumber].Options[1]}
        </text>
  </g>
 ...
 {/*  Answer Box C */}
  ...
  >
    <path 
        ...
        >
           C. {scienceQuestions.the_galaxies[questionNumber].Options[2]}
        </text>
  </g>
 ...
 {/*  Answer Box D */}
  ...
  >
    <path 
        ...
        >
          D. {scienceQuestions.the_galaxies[questionNumber].Options[3]} 
        </text>
  </g> 
