...
const Dentition = () => {
   ...
   const xp = useXpStore((state) => state.xp)
    ...
    const lines =  wrapText(scienceQuestions.dentition_in_humans[questionNumber].question)
    
    

    
    const answer = scienceQuestions.dentition_in_humans[questionNumber].answer;
      const [A_answer, B_answer, C_answer, D_answer] = scienceQuestions.dentition_in_humans[questionNumber].options;
    ...
    useEffect(()=>{
      ...
      function check_A_Answer() {
        ...
        if (
          scienceQuestions.dentition_in_humans[questionNumber].answer ===
          scienceQuestions.dentition_in_humans[questionNumber].options[0]
        ) {
           setWrongAnswerA(false);
          setCorrectAnswerA(true);   
          setBorderColorA(glowCorrect);
       ...
       if(B_answerBox){
        ...
        if (
          scienceQuestions.dentition_in_humans[questionNumber].answer === scienceQuestions.dentition_in_humans[questionNumber].options[1]
        ) {
          setCorrectAnswerB(true);
          setWrongAnswerB(false);
         setBorderColorB(glowCorrect);
        ...
        if (
          scienceQuestions.dentition_in_humans[questionNumber].answer ===
          scienceQuestions.dentition_in_humans[questionNumber].options[2]
        ) {
        ...
        if (
          scienceQuestions.dentition_in_humans[questionNumber].answer === scienceQuestions.dentition_in_humans[questionNumber].options[3]
        ) {
          setCorrectAnswerD(true);
          setWrongAnswerD(false);
          setBorderColorD(glowCorrect);
      ...
      useEffect(()=>{
        if (nextQuestion) {
         ...
         //alert('next question')
          ...
          if (questionNumber === scienceQuestions.dentition_in_humans.length - 1) {
            confetti({
              particleCount: 100,
              spread: 70,
              origin: { y: 0.6 },
     ...
     style = {{
      ...
      >
        ...
        /> 
          ...
          >
             {`[ ${questionNumber} / ${scienceQuestions.dentition_in_humans.length} ]`}  
          </text>  
      </g>
...
/*  Answer Box A  */
  ...
  >
    <path 
        ...
        >
        A. {scienceQuestions.dentition_in_humans[questionNumber].options[0]}
        </text>
  </g>
  ...
  >
    <path 
        ...
        >
         B. {scienceQuestions.dentition_in_humans[questionNumber].options[1]}
        </text>
  </g>
 ...
 {/*  Answer Box C */}
  ...
  >
    <path 
        ...
        >
           C. {scienceQuestions.dentition_in_humans[questionNumber].options[2]}
        </text>
  </g>
 ...
 {/*  Answer Box D */}
  ...
  >
    <path 
        ...
        >
          D. {scienceQuestions.dentition_in_humans[questionNumber].options[3]} 
        </text>
  </g> 
